...
df_res = load_portal_no_replaced()
...
print(f"============================================================")
print(f"=== No replaced_indices Test Result ===")
print(f"============================================================")
print(f"Total calculated across 167 departments: {total_167:15,.0f} 천원")
print(f"Target PDF total:                        {sum(pdf_targets.values()):15,.0f} 천원")
print(f"Total diff:                              {total_167 - sum(pdf_targets.values()):+15,.0f} 천원")
print(f"Discrepancies count:                     {len(discrepancies)}개 부서")
