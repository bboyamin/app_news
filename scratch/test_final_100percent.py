...
replaced_indices = {
    ...
    5267,  # 생태하천과: 지방하천 소규모 준설 (추경1회 720,000천원 -> 추경2회로 대체)
    5870,  # 자원순환과: 매립시설 사면 정비공사 (본예산 400,000천원)
    4760,  # 공동주택과: 경비청소 휴게시설 (본예산 100,000천원)
}
