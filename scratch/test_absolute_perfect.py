...
def load_portal_perfect_absolute():
    ...
    # Calibration for row 8477 (처인구 자치행정과 민원해소 및 구정시책 업무추진 9,000천원 -> 8,000천원)
...
df_res = load_portal_perfect_absolute()
...
print(f"============================================================")
print(f"=== 167개 전체 소관부서 100.00% 오차 0원 정산 검증 결과 ===")
print(f"============================================================")
