...
print(f'TOTAL_SUM_ALL={total_sum:,.0f}')
print(f'DISCREPANCY_COUNT={len(discrepancies)}')
for d, c, t, diff in sorted(discrepancies, key=lambda x: abs(x[3]), reverse=True)[:15]:
